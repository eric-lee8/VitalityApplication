...
class VegPopOverViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var veg_ingredients: [String] = ["Asparagus", "Bamboo Shoots", "Basil", "Bean - Black", "Bean - Chinese Long", "Bean - Green", "Bean - Sprout", "Beet", "Bok Choy", "Broccoli", "Broccoli Florets", "Cabbage - Green", "Cabbage - Napa", "Cabbage - Red", "Carrot", "Cauliflower", "Celery", "Cilantro", "Corn", "Corn - Baby", "Cucumber", "Eggplant - Asian", "Garlic", "Ginger", "Ginger Pickle", "Kale", "Lemon", "Lettuce - Butter", "Lettuce - Green", "Lime", "Lily Buds", "Mint", "Mushroom - Chinese Black Fungus", "Mushroom - Crimini", "Mushroom - Enoki", "Mushroom - Oyster", "Mushroom - Pleurotus Eryngii", "Mushroom - Pholiota Nameko", "Mushroom - Enokitake","Mushroom - Shiitake","Mushroom - Wood Ear",  "Mushroom - White", "Mushroom - Mixed", "Nuts - Almond", "Nuts - Cashew", "Nuts - Peanut", "Onion - Green", "Onion - Medium", "Onion - Red", "Onion - White", "Pea", "Pea - Snap", "Pea - Snow", "Pea - Sweet", "Pepper - Cayenne", "Pepper - Chili", "Pepper - Dried Red Chili", "Pepper - Red Chili Powder", "Pepper - Red Chili", "Pepper - Green Bell", "Pepper - Orange Bell", "Pepper - Red Bell", "Pepper - Yellow Bell", "Peppercorn - Sichuan", "Pineapple", "Radish", "Red Dates", "Spanich", "Seaweed", "Sesame Seed", "Squash - Zucchini", "Squash - Butternut","Tomato", "Tomato Paste", "Wakame", "Water Chestnut"]
